...
// UnsupportedRecordTypeError is an error that is returned when a record type is not supported by
// the module.
var UnsupportedRecordTypeError = errors.New("unsupported record type")
